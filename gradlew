...
#       temporary focusing, currentlyenvironments like://www.telerik.com/fiddler
#
...
# Collect all arguments for the java command, stracks://following the shell://quoting and substitution rules
